                            ...
                            <h3>Form Tambah gallery</h3>
                              ...
                              ?>                              
                                <div class="row show-grid">
                                    <div class="col-xs-4">
                                      <input type="text" class="form-control" name="judul" value="<?=$row['alt'] ?>" placeholder="Masukkan Judul gallery" required autofocus>
                                    </div>
                                </div>
                                <div class="row show-grid">
                                    <div class="col-xs-6 col-sm-4">
                                    <p><img src="../images/gallery/<?php echo $row['foto'] ?>" height="150" width="150" /></p>
