                        ...
                        if ($imgs) {
                            foreach ($imgs as $row) {
                                ...
                                <div class="col-md-3">
                                    ...
                                    <?php
                                    if($row->is_active == 1) {
                                        echo ' <a href="#" class="btn btn-xs btn-warning" style="float: right; margin-top:-10px; z-index: 3000;" onclick="statusImg(\''.$row->gallery_detail_id.'\', 0);"><i class="fa fa-eye"></i> Nonaktifkan </a> &nbsp;';
                                    } else {
                                        echo ' <a href="#" class="btn btn-xs btn-success" style="float: right; margin-top:-10px; z-index: 3000;" onclick="statusImg(\''.$row->gallery_detail_id.'\', 1);"><i class="fa fa-eye"></i> Aktifkan </a> &nbsp;';
                                    }
                                    ?>

                                    <a href="#" class="btn btn-xs btn-danger" style="float: right; margin-top:-10px; z-index: 3000;" onclick="hapusImg('<?php echo $row->gallery_detail_id;?>');"><i class="fa fa-trash-o"></i> Delete</a>
                                </div>
                            <?php
                            }
                        }
