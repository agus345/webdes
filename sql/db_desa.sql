...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Jul 2017 pada 13.04
...
(2, 'Nasi Jamblang', 'aaaaa', 'xcxcvxxc', '20140528_092504.jpg', 1, '1');
...
CREATE TABLE `perdes` (
  ...
  `status` char(1) NOT NULL DEFAULT '1' COMMENT '1 (aktif), 2 (tidak aktif)'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('Pak Kades', 'Kepala Desa', '2010-2023', '3images.jpg', 'Hello Selamat Siang');
